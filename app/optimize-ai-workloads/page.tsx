...
import { OptimizeAiHero } from "@/components/optimize-ai-workloads/optimize-ai-hero"
...
export const metadata: Metadata = {
  title: "Optimize AI Workloads | PointFive — Visibility, Allocation & Savings Across Every Cloud",
  description:
    "Optimize AI workloads for efficiency and performance across Azure OpenAI, AWS Bedrock, and GCP Vertex AI. PointFive gives engineering teams full visibility into AI spend, team-level cost allocation, and continuous optimization — from token-level economics to PTU rightsizing. See savings in 48 hours.",
  keywords: [
  ...
  openGraph: {
    title: "Optimize AI Workloads | PointFive",
    description:
    ...
    type: "website",
    url: "https://www.pointfive.co/optimize-ai-workloads",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://www.pointfive.co/optimize-ai-workloads",
  },
}
...
const jsonLd = {
  ...
  "@type": "WebPage",
  name: "Optimize AI Workloads",
  description:
    "Optimize AI workloads for efficiency and performance across Azure OpenAI, AWS Bedrock, and GCP Vertex AI with PointFive. Full visibility, team allocation, and continuous optimization.",
  provider: {
    "@type": "Organization",
    name: "PointFive",
...
export default function OptimizeAiWorkloadsPage() {
  return (
    <>
      <script
