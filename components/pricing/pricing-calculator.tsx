...
export function PricingCalculator() {
  ...
  const roiDisplay = Math.min(roi, MAX_ROI_DISPLAY) // Cap at average to keep estimates realistic
  ...
  return (
    <div className="mx-auto max-w-[900px] px-6 py-14 pb-20 md:py-16">
      {/* Slider card */}
      <div className="mb-7 rounded-sm border border-border bg-card p-8 shadow-sm md:p-10 md:pb-11">
        <div className="mb-3 text-[13px] font-semibold uppercase tracking-wider text-neutral-600">
          Annual Cloud Spend
        </div>
        <div className="mb-8 flex items-baseline gap-1.5">
          <span className="text-2xl font-light text-neutral-600 md:text-3xl">
            $
          </span>
          <span
          ...
          <span className="text-lg font-light text-neutral-600">/ year</span>
        </div>
        ...
        <div className="mt-7 border-t border-border pt-6">
          <div className="mb-3 text-[11px] font-semibold uppercase tracking-wider text-neutral-600">
            Your pricing tier
          </div>
          <div className="grid grid-cols-5 gap-1.5">
            {TIERS.map((t) => (
              <div
                key={t.id}
                className={cn(
                  "rounded-sm border-2 px-2 py-2.5 text-center transition-colors",
                  t.id === tier.id
              ...
              >
                <div
                  className={cn(
                    ...
                    t.id === tier.id ? "text-primary" : "text-neutral-600"
                  )}
                >
                  {t.name}
                </div>
          ...
          <div className="mt-3.5 flex items-center justify-between rounded-sm border border-primary/20 bg-primary/5 px-5 py-3.5">
            <div>
            ...
            <div className="text-right">
              ...
              <div className="text-[11px] text-neutral-600">per year</div>
            </div>
          </div>
        </div>
      </div>

      {/* Invoice card — fixed columns for alignment */}
      <div className="mb-7 overflow-hidden rounded-sm border border-border bg-card shadow-sm">
        ...
        <div className="grid grid-cols-[1fr_5.5rem_9rem] gap-4 border-b border-border px-6 py-4 md:px-8">
          ...
          <span className="rounded-sm bg-accent/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-accent">
            +Savings
          </span>
        ...
        <div className="grid grid-cols-[1fr_5.5rem_9rem] gap-4 border-b border-border px-6 py-4 md:px-8">
          ...
          <span className="rounded-sm bg-neutral-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-neutral-600">
            Included
          </span>
          <span className="font-mono text-[17px] font-medium tabular-nums text-right text-neutral-700">
            Varies
          </span>
        </div>
        ...
        <div className="grid grid-cols-[1fr_5.5rem_9rem] gap-4 border-b border-border px-6 py-4 md:px-8">
          ...
          <span className="rounded-sm bg-accent/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-accent-muted">
            Included
          </span>
        ...
        <div className="grid grid-cols-[1fr_5.5rem_9rem] gap-4 bg-neutral-50/80 px-6 py-4 md:px-8">
          <div className="min-w-0 border-t-2 border-border pt-4">
      ...
      {/* Net Zero banner */}
      <div className="relative mb-7 overflow-hidden rounded-sm border border-primary/30 bg-gradient-to-br from-[#000] to-[#111] px-8 py-8 md:px-9 md:py-8">
        <div
        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <div className="mt-2 text-2xl font-normal text-white">
              Guaranteed net positive every term
            </div>
            <div className="mt-1.5 text-[13px] leading-relaxed text-white/50">
              If at end of year we don&apos;t find more cost optimizations than
              you&apos;ve spent on our software, we waive the difference. Most
              cover their annual fee in a month — Nubank did it in 10 days.
            </div>
            <Link
              href="/net-zero"
      ...
      <div className="mb-7 grid gap-4 sm:grid-cols-3">
        <div className="rounded-sm border border-primary bg-primary/5 p-5 text-center">
        ...
        <div className="rounded-sm border border-border bg-card p-5 text-center shadow-sm">
      ...
      {/* Assumptions */}
      <div className="mb-10 flex flex-wrap items-center justify-between gap-6 rounded-sm border border-border bg-card px-6 py-5">
      ...
      <div className="text-center pt-4">
        ...
        <a
          ...
          className="mt-7 inline-block rounded-sm bg-primary px-8 py-3.5 text-[15px] font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-primary-dark hover:shadow-lg hover:shadow-primary/30"
        >
